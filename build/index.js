...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
   ...
   */
  var activeEnableBlockStyles = (_window$ups_editorial2 = window.ups_editorial) === null || _window$ups_editorial2 === void 0 ? void 0 : _window$ups_editorial2.enable_block_styles;
  ['button', 'image', 'quote', 'separator', 'table'].filter(function (blockName) {
    return !activeEnableBlockStyles || activeEnableBlockStyles.indexOf(blockName) === -1;
  }).forEach(function (blockName) {
    return wp.blocks.getBlockType("core/".concat(blockName)).styles.forEach(function (_ref6) {
      var styleName = _ref6.name;
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.unregisterBlockStyle)("core/".concat(blockName), styleName);
    });
  });
