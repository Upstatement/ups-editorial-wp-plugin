...
function add_attachment_field($id, $label, $input, $helps = '') {
    ...
    */
    add_filter('attachment_fields_to_edit', function($form_fields, $post) use ($id, $label, $input, $helps) {
    ...
    */
    add_filter('attachment_fields_to_save', function($post, $attachment) use ($id, $label, $input, $helps) {
