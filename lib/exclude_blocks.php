 ...
 */
function get_blocks_with_exclude_list($exclude_list = []) {
 ...
 * @param object $post the current post using the selector
 *
 * @return array|boolean an array of allowed blocks, or true to allow all blocks
 */
function exclude_blocks($allowed_block_types, $post) {
